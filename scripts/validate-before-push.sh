...
VM_SMOKE_HOSTS="${PWNED_CHECK_VM_SMOKE_HOSTS:-codex-vm-ubuntu codex-vm-debian codex-vm-ubuntu-arm64 codex-vm-debian-arm64 codex-vm-fedora codex-vm-rocky codex-vm-alpine codex-vm-alpine-arm64 codex-vm-arch}"
...
vm_goarch() {
    case "$1" in
        codex-vm-ubuntu-arm64 | codex-vm-debian-arm64 | codex-vm-alpine-arm64)
            printf '%s\n' arm64
            ;;
        *)
            printf '%s\n' amd64
