...
echo "make private-signing-material-guard-test ci-repository-signing-keys-test package-repository-pages-publish-test native-pam-repo-endpoint-retry-test private-signing-material-check"
make private-signing-material-guard-test ci-repository-signing-keys-test package-repository-pages-publish-test native-pam-repo-endpoint-retry-test private-signing-material-check
